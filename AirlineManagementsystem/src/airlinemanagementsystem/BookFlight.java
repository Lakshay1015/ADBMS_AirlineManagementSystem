...
public class BookFlight extends JFrame implements ActionListener{
    ...
    public BookFlight() {
        ...
        lblaadhar.setBounds(60, 90, 150, 25);
        lblaadhar.setFont(new Font("Tahoma", Font.PLAIN, 17));
        add(lblaadhar);
        
        tfaadhar = new JTextField();
        tfaadhar.setBounds(220, 90, 150, 25);
        ...
        fetchButton.setBounds(380, 90, 140, 25);
        ...
        lbldest.setFont(new Font("Tahoma", Font.PLAIN, 17));
        add(lbldest);
        ...
        lblfname.setFont(new Font("Tahoma", Font.PLAIN, 17));
        add(lblfname);
        ...
        lblimage.setBounds(580, 80, 500, 410);
        add(lblimage);
        ...
        if (ae.getSource() == fetchButton) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Invalid Passenger Details, Enter Correct Details");                
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "NO direct flights available!");                
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
