...
public class BoardingPass extends JFrame implements ActionListener{
    ...
    public BoardingPass() {
        ...
        JLabel heading = new JLabel("LUFTHANSA");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airlinemanagementsystem/icons/Lufthansa.jpg"));
        Image i2 = i1.getImage().getScaledInstance(300, 230, Image.SCALE_DEFAULT);
        ImageIcon image = new ImageIcon(i2);
        JLabel lblimage = new JLabel(image);
        lblimage.setBounds(550, 0, 300, 300);
        add(lblimage);
    ...
    public void actionPerformed(ActionEvent ae) {
            ...
            try {
               ...
               if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Invalid Details, enter correct PNR");                
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
